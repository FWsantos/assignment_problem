...
import platform
import numpy as np
from lib.LSAP.utils import gen_phi
from instances.LSAP.utils import read_file, read_big_file, get_files_path
from lib.LSAP.hungarian_n3 import hungarian_n3
from scipy.optimize import linear_sum_assignment

def exec_lsap_hungarian_n3(output_file_name, type_set=0, type_test=0):
    """
...
def exec(qap=0, type_set=0, type_test=0):
    """
    ...
    - type_test (int): The type of test to perform. 0 for N3 algorithm, 1 for scipy implementation. Default is 0.
    """
    current_folder = './src/instances/LSAP/output/'
    output_file_name = ''
    if qap == 1:
        output_file_name = 'qap_'
    else:
        output_file_name = 'lsap_'
    if type_set == 0:
    ...
    exec_lsap_hungarian_n3(output_file_name, type_set)
